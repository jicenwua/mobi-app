/**
 * app-customer 模块接口路径（MobiUserController @RequestMapping("/app")）
 */
...
/** 与后端 ShopUserRole.code 一致 */
export const SHOP_LIST_STATUS = {
	MANAGER: 1,
	CLERK: 2,
	CUSTOMER: 3
}
...
/**
 * 小程序权限（与 app-customer Controller @PreAuthorize、mobi_role.role_key 一致，wx: 前缀）
 *
 * 前后端同一能力须使用同一 role_key，见 utils/wx-perm.js
 */
export const WX_PERM = {
