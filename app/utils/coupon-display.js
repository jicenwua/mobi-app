export const COUPON_TYPE_LABELS = { 1: '折扣', 2: '满减' }

export const COUPON_ICON_MAP = {
	1: '/static/折扣券.png',
	2: '/static/满减券.png'
}

export function couponIconSrc(type) {
...
/**
 * @param {object | null | undefined} coupon
 * @param {{ emptyValueFallback?: boolean }} [options] emptyValueFallback: value 为空时用类型标签（我的优惠券页）
 */
export function formatCouponDesc(coupon, options = {}) {
	if (!coupon) return ''
...
export function formatCouponRemaining(coupon) {
	if (!coupon) return '0'
