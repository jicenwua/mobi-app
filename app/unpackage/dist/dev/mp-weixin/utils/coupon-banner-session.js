...
function hasDismissedCouponBanner(shopId) {
...
function markCouponBannerDismissed(shopId) {
  const id = normalizeShopId(shopId);
  if (!id)
    return;
  try {
...
exports.hasDismissedCouponBanner = hasDismissedCouponBanner;
exports.markCouponBannerDismissed = markCouponBannerDismissed;
